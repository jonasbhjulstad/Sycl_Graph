...
#    endif()
    ...
    target_link_options(${source_file} PUBLIC ${DPCPP_FLAGS}-std=c++20)
endfunction()
...
function(add_custom_interface_library libname)
    ...
    target_compile_options(${libname} INTERFACE -fsycl -std=c++20)
...
#    endif()
    ...
    target_link_options(${libname} INTERFACE ${DPCPP_FLAGS}-std=c++20)
endfunction()
