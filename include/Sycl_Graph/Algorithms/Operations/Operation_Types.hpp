...
typedef std::shared_ptr<sycl::buffer<Operation_Buffer_Void_t>> p_Operation_Buffer_Void_t;
...
struct Transform_Operation
{
    ...
    void _invoke(const auto &, const auto &source_acc, auto &target_acc, sycl::handler &h)
    {
