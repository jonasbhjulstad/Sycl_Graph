...
import Base.Graph;
    ...
    struct Buffer
    {
        ...
        Buffer<uint32_t, Ds...> &operator=(const Buffer<uint32_t, Ds...> &other)
        {
            bufs = other.bufs;
            return *this;
        }
    ...
    template <typename T>
    export concept Buffer_type = true;

    template <Sycl::Buffer_type ... Bs>
    export struct Buffer_Pack: public Buffer_Pack<Bs ...>
    {

        using Base_t = Buffer_Pack<Bs ...>;
    ...
    template <typename T>
    export concept Buffer_Pack_type = true;
    template <Sycl::Buffer_type ... Bs>
