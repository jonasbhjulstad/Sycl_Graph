export module Sycl.Buffer.Vertex;
#include <Sycl_Graph/Common/common.hpp>

template <sycl::access::mode Mode, Vertex_type Vertex_t>
export struct Vertex_Accessor: public Buffer_Accessor<Mode, typename Vertex_t::ID_t, typename Vertex_t::Data_t>
{
...
template <Vertex_type _Vertex_t>
export struct Vertex_Buffer : public Buffer<uint32_t, typename _Vertex_t::ID_t,
                                     typename _Vertex_t::Data_t> {

  typedef Buffer<uint32_t, typename _Vertex_t::ID_t,
...
template <typename T>
export concept Vertex_Buffer_type = Vertex_Buffer_type<T>;
