#ifndef SYCL_GRAPH_EPIDEMIOLOGICAL_SIR_SYCL_INDIVIDUAL_HPP
#define SYCL_GRAPH_EPIDEMIOLOGICAL_SIR_SYCL_INDIVIDUAL_HPP
#include <Sycl_Graph/Epidemiological/SIR/Individual.hpp>
...
namespace Sycl_Graph::Epidemiological
{
    ...
    typedef Buffer_Pack<SIR_Individual_Infection_Edge_Buffer_t, SIR_Individual_Recovery_Edge_Buffer_t> SIR_Individual_Edge_Buffer_Pack_t;
    typedef Invariant_Graph<SIR_Individual_Vertex_Buffer_Pack_t, SIR_Individual_Edge_Buffer_Pack_t> SIR_Individual_Graph_t;
